...
register_sidebar([
    'name' => 'サイドバー',
    'id' => 'sidebar',
    'before_widget' => '<div class="%1$s %2$s sidebar-widget margin-bottom-1_5em">',
    'after_widget' => '</div>',
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s slide-widget">',
    'after_widget' => '</div>',
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s header-widget margin-1em-auto padding-0-10px">',
    'after_widget' => '</div>',
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s post-top-widget margin-1em-auto">',
    'after_widget' => '</div>',
    'before_title' => '<p class="widget-title">',
    'after_title' => '</p>',
]);
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s ad text-align-center post-h2-widget margin-1_5em-auto clearfix">',
    'after_widget' => '</div>',
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s ad text-align-center post-bottom-ad-widget margin-1_5em-auto clearfix">',
    'after_widget' => '</div>',
    'before_title' => '<p class="ad-title">',
    'after_title' => '</p>',
]);
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s post-bottom-widget margin-1_5em-auto">',
    'after_widget' => '</div>',
    'before_title' => '<p class="widget-title">',
    'after_title' => '</p>',
]);
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s footer-widget margin-bottom-2em">',
    'after_widget' => '</div>',
    'before_title' => '<h4>',
    'after_title' => '</h4>',
]);
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s fixed-footer-widget">',
    'after_widget' => '</div>',
]);
register_sidebar([
    'name' => '一覧記事インフィード広告',
...
register_sidebar([
    ...
    'before_widget' => '<div class="header-widget amp-header-widget"><div class="%1$s %2$s inner">',
...
register_sidebar([
    ...
    'before_widget' => '<div class="%1$s %2$s ad text-align-center post-h2-widget margin-1_5em-auto">',
    'after_widget' => '</div>',
    'before_title' => '<p class="ad-title">',
    'after_title' => '</p>',
]);
register_sidebar([
    ...
    'id' => 'amp-post-ad',
    'description' => '※アドセンスは外観→カスタマイズにて設定。AMPに対応してないタグを使うとエラーになります。',
    'before_widget' => '<div class="%1$s %2$s ad text-align-center post-bottom-ad-widget margin-1_5em-auto">',
    'after_widget' => '</div>',
    'before_title' => '<p class="ad-title">',
    'after_title' => '</p>',
]);
