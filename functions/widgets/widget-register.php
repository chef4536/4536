...
register_sidebar([
    ...
    'before_widget' => '<div class="widget-4536 w-100 %1$s %2$s post-h2-widget mb-5" data-text-align="center">',
    'after_widget' => '</div>',
...
register_sidebar([
    ...
    'before_widget' => '<div class="widget-4536 w-100 %1$s %2$s post-bottom-ad-widget mt-4" data-text-align="center">',
    'after_widget' => '</div>',
    'before_title' => '<div class="meta mb-2 post-color">',
    'after_title' => '</div>',
]);
