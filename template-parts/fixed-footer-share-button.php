...
<div id="fixed-footer-share-menu-contents">
    ...
    <div id="fixed-footer-menu-sns" class="pa-4 b-0 r-0 l-0" data-bg-color="white" data-display="none">
        <?php sns_button_4536(); ?>
        <label for="share-menu-toggle" data-display="flex" data-justify-content="center" data-align-items="center" class="flex close-button pt-4"><?php echo icon_4536('close', get_theme_mod('post_color'), 24); ?>CLOSE</label>
    </div>
</div>
