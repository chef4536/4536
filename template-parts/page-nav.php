...
if($prevpost) { //前の記事が存在しているとき
    echo '<a id="prev-post" class="clearfix flexbox-row-wrap post-color" href="' . get_permalink($prevpost->ID) . '">'.
...
if($nextpost) { //次の記事が存在しているとき
    echo '<a id="next-post" class="clearfix flexbox-row-wrap post-color" href="' . get_permalink($nextpost->ID) . '">'.
